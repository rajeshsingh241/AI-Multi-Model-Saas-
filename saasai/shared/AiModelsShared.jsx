...
// DefaultModel: now includes all enabled models for backend validation
export const DefaultModel = {
  ...
  Mistral: { modelId: "Ministral-3B", enable: true },
...
// This exports an array of ALL enabled submodel IDs (for backend validation)
export const enabledModelIds = [
  ...[
    {
      model: "GPT",
      enable: true,
      subModel: [
        { id: "gpt-3.5", premium: false },
        { id: "gpt-3.5-turbo", premium: false },
        { id: "gpt-4.1-mini", premium: false },
        { id: "gpt-4.1", premium: true },
        { id: "gpt-5-nano", premium: false },
        { id: "gpt-5-mini", premium: false },
        { id: "gpt-5", premium: true },
      ],
    },
    {
      model: "Gemini",
      enable: true,
      subModel: [
        { id: "gemini-2.5-flash-lite", premium: false },
        { id: "gemini-2.5-flash", premium: false },
        { id: "Gemini 2.5 Pro", premium: true },
      ],
    },
    {
      model: "DeepSeek",
      enable: true,
      subModel: [
        { id: "DeepSeek-R1", premium: false },
        { id: "DeepSeek-R1-0528", premium: true },
      ],
    },
    {
      model: "Mistral",
      enable: true,
      subModel: [
        { id: "mistral-medium-2505", premium: true },
        { id: "Ministral-3B", premium: false },
      ],
    },
    {
      model: "Grok",
      enable: true,
      subModel: [
        { id: "grok-3-mini", premium: false },
        { id: "grok-3", premium: true },
      ],
    },
    {
      model: "Cohere",
      enable: true,
      subModel: [
        { id: "cohere-command-a", premium: false },
        { id: "Cohere-command-r-08-2024", premium: false },
      ],
    },
    {
      model: "Llama",
      enable: true,
      subModel: [
        { id: "Llama-3.3-70B-Instruct", premium: true },
        { id: "Llama-4-Scout-17B-16E-Instruct", premium: true },
      ],
    },
  ].flatMap(model =>
    model.enable
      ? model.subModel.map(sub => sub.id)
      : []
  )
];
